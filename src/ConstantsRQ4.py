...
DATA_DIR = os.path.normpath(os.path.join(THIS_DIRECTORY, '../data/other_domain/'))
DATA_Emulators_DIR = os.path.normpath(os.path.join(THIS_DIRECTORY, '../data/other_domain/Emulators'))
RESULT_Emulators_DIR = os.path.normpath(os.path.join(THIS_DIRECTORY, '../other_domain_results/Emulators'))
...
APP IDs
""" 
Citra_ID = 'org.citra.citra_emu'
Dolphin_ID = 'org.dolphinemu.dolphinemu'
Mupen64Plus_ID = 'org.mupen64plusae.v3.fzurita'
openMSX_ID = 'com.fms.fmsx'
PPSSPP_ID = 'org.ppsspp.ppsspp'
RetroArch_ID = 'com.retroarch.aarch64'
ScummVM_ID = 'org.scummvm.scummvm'
VICE_ID = 'com.vice.viceforandroid'

APP_IDS = [Citra_ID, Dolphin_ID, Mupen64Plus_ID, openMSX_ID, PPSSPP_ID, RetroArch_ID, ScummVM_ID, VICE_ID]
...
APPS = [Citra, Dolphin, Mupen64Plus, openMSX, PPSSPP, RetroArch, ScummVM, VICE]
...
CITRA_ISSUES_Repo = 'citra-emu/citra'
DOLPHIN_ISSUES_Repo = 'dolphin-emu/dolphin'
MUPEN64PLUS_ISSUES_Repo = ''
OPENMSX_ISSUES_Repo = ''
PPSSPP_ISSUES_Repo = ''
RETROARCH_ISSUES_Repo = ''
SCUMMVM_ISSUES_Repo = ''
VICE_ISSUES_Repo = ''
